...
- ✅ Interactive done (9/20): arrays-hashing, two-pointers, sliding-window, binary-search, stack,
  queues-deques, linked-lists (+ framework).
- ⏳ Remaining 11 topics: sorting-divide-conquer, trees, tries, heap-priority-queue, backtracking,
  graphs, advanced-graphs, dp-1d, dp-2d, greedy, intervals, math-bit, union-find.
  Renderer library complete; remaining work is prose + concept-viz authoring per topic.
