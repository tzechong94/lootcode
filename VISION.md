...
- ✅ Interactive done (7/20): arrays-hashing, two-pointers, sliding-window, binary-search, stack,
  queues-deques, linked-lists (+ framework).
- ⏳ Remaining 13 topics: sorting-divide-conquer, trees, tries, heap-priority-queue, backtracking,
